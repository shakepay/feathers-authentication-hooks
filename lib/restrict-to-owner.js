...
exports.default = function () {
  ...
  return function (hook) {
    ...
    var _hook$app$get = hook.app.get('authentication'),
        entity = _hook$app$get.entity;
    ...
    if (!hook.params[entity]) {
      ...
      throw new _feathersErrors2.default.NotAuthenticated('The current ' + entity + ' is missing. You must not be authenticated.');
    }

    var id = (0, _lodash4.default)(hook.params[entity], options.idField);
